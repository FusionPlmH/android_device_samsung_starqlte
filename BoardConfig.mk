...
TARGET_PREBUILT_KERNEL := device/samsung/starqlte/kernel
...
TARGET_RECOVERY_FSTAB := device/samsung/starqlte/recovery/root/etc/recovery.fstab
TARGET_USE_CUSTOM_LUN_FILE_PATH := "/config/usb_gadget/g1/functions/mass_storage.0/lun.%d/file"
TW_NO_HAPTICS := true
# system.prop
TARGET_SYSTEM_PROP := device/samsung/starqlte/system.prop
